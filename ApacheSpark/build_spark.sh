...
function configureAndInstall() {
	...
	# replace config file
	patch "${CURDIR}/common/unsafe/src/main/java/org/apache/spark/unsafe/Platform.java" Platform.diff
	printf -- 'Platform.java \n'  >> "$LOG_FILE"
    
    # Patch OffHeapColumnVector.diff
	curl -o "OffHeapColumnVector.diff"  $CONF_URL/OffHeapColumnVector.diff
	# replace config file
	patch "${CURDIR}/sql/core/src/main/java/org/apache/spark/sql/execution/vectorized/OffHeapColumnVector.java" OffHeapColumnVector.java.diff
	...
	# replace config file
	patch "${CURDIR}/sql/core/src/main/java/org/apache/spark/sql/execution/vectorized/OnHeapColumnVector.java" OnHeapColumnVector.java.diff
	...
	# replace config file
	patch "${CURDIR}/core/src/test/scala/org/apache/spark/metrics/sink/StatsdSinkSuite.scala" StatsdSinkSuite.diff
...
function gettingStarted() {
    ...
    printf -- "export PATH="\$PATH:$CURDIR/spark" \n"
